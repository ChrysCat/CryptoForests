...
contract TheToken is IERC20, ERC20Detailed, Ownable, ITheToken {
  ...
  constructor() ERC20Detailed("Leaf Coin", "LEAF", 18) public {
    t0 = now;
    t1 = now.add(age);
  }
  ...
  function mint(address receiver) public payable {
    ...
    require(payment >= 1e14,"insufficient payment");
  ...
  function _transfer(address sender, address recipient, uint256 virtualAmount) internal {
  ...
  function _mint(address account, uint256 amount, uint256 eventAmount) internal {
  ...
  function _burn(address account, uint256 amount, uint256 eventAmount) internal {
